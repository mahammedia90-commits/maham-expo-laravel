...
Route::prefix('v1')->group(function () {
    ...
    //    TODO: Integrate OneSignal notifications
    //     Route::prefix('notifications')->middleware(['auth:sanctum', 'check_deleted'])->group(function () {
    //     Route::get('/', [OneSignalNotificationController::class, 'index']);
    //     Route::post('/send', [OneSignalNotificationController::class, 'send']);
    //     Route::get('/status', [OneSignalNotificationController::class, 'status']);
    //     Route::post('/mark-as-seen', [OneSignalNotificationController::class, 'markAsSeen']);
    //     Route::post('/mark-all-as-read', [OneSignalNotificationController::class, 'markAllAsRead']);
    //     Route::get('/{id}', [OneSignalNotificationController::class, 'show']);
    //     Route::delete('/{id}', [OneSignalNotificationController::class, 'destroy']);
    // });
        ...
        Route::prefix('investor')->middleware([CheckRole::class . ':investor'])->group(function () {
            // Investor-specific routes can be defined here
            // For example, managing their own rental requests, viewing investment opportunities, etc.
        });


            // ====================  MERCHANT ROUTES ====================
        Route::prefix('merchant')->middleware([CheckRole::class . ':merchant'])->group(function () {
            // Merchant-specific routes can be defined here
            // For example, managing their own events, spaces, services, etc.   
        });
    });
